...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'unique_list' => [
            'name' => 'The :attribute already exist within this group.',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'list_id' => 'list',
        'list_ids' => 'list',
        'broadcast_ids' => 'campaign',
        'role_id' => 'role',
        'group_id' => 'group',
        'campaign_id' => 'campaign',
        'sending_server_id' => 'sending server',
        'sending_server_ids' => 'sending server',
        'bounce_id' => 'bounce email',
    ],
];
