      ...
      <div class="box-body">
        ...
        <div class="form-group" id="speed-attributes" style="display: none;">
          <div class="col-md-offset-2 col-md-3">
            <input type="number" class="form-control" name="limit" value="" min="1" placeholder="100">
          </div>
          <div class="col-md-3"> 
        ...
        <div class="form-group">
          <div class="col-md-offset-2 col-md-6">
            <button type="button" class="btn btn-primary" onclick="submitData(this, this.form, 'POST', '{{ route('schedule_campaign.store') }}', 2)" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> {{ __('app.save_add_exit') }}">{{ __('app.save_add_exit') }}</button>
