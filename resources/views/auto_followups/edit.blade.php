...
<div class="modal-content">
  <div class="modal-header">
    ...
    <h4 class="modal-title">{{ __('app.edit_auto_followup') }}</h4>
  </div>
      ...
      <div class="box-body">
        <div class="form-group">
          ...
          <div class="col-md-3" data-toggle="tooltip" title="{{ __('help.auto_followup_status') }}">
            <input type="checkbox" name="active" data-toggle="toggle" data-size="small" data-on="{{ __('app.active') }}" data-off="{{ __('app.inactive') }}" {{ $auto_followup->active == 'Yes' ? 'checked="checked"' : ''}}>
          </div>
        </div>
        <div class="form-group">
          <label class="col-md-3 control-label">{{ __('app.name') }} <span class="required">*</span></label>
          <div class="col-md-8">
            <input type="text" class="form-control" name="name" value="{{ $auto_followup->name }}" placeholder="{{ __('app.auto_followup_name') }}">
          </div>
          <span></span>
        </div>
        <div class="form-group">
          ...
          <div class="col-md-8">
            <div class="input-group from-group">
              @php $segment_id = $auto_followup->segment_id @endphp
        ...
        <div class="form-group">
          ...
          <div class="col-md-8">
            <div class="input-group from-group">
              @php $broadcast_id = $auto_followup->broadcast_id @endphp
        ...
        <div class="form-group">
          ...
          <div class="col-md-8">
            <div class="input-group from-group">
              @php $sending_server_id = $auto_followup->sending_server_id @endphp
        ...
        <div class="form-group">
          <div class="col-md-offset-3 col-md-9">
            <button type="button" class="btn btn-primary" onclick="submitData(this, this.form, 'PUT', '{{ route('auto_followup.update', ['id' => $auto_followup->id]) }}');" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> {{ __('app.save') }}">{{ __('app.save') }}</button>
