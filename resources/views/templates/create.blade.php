...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">{{ __('app.add_new_template') }}</li>
  </ol>
</section>
  ...
  <div class="box">
    <div class="box-body">
      <div class="form-group col-md-12">
        <iframe src="/get_mc_builder?id={{$id}}&action={{$action}}" frameborder="yes" border="1" scrolling="yes" height="900" width="100%"></iframe>
      </div>
    </div>
    <!-- /.box-body -->
  </div>
