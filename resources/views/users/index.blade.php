...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">{{ __('app.users') }}</li>
  </ol>
</section>
...
<section class="content">
  <div class="box">
    <div class="box-body">
        ...
        <div class="left">
          <a href="{{route('user.create')}}"><button class="btn btn-primary">{{ __('app.add_new_user') }}</button></a>
        </div>
        <div class="right">
          <div class="btn-group">
            ...
            <ul class="dropdown-menu" role="menu">
              <li><a href="javascript:;" onclick="destroyMany('{{ route('user.destroy', ['id' => 0]) }}')"><i class="fa fa-trash"></i>{{ __('app.delete') }}</a></li>
            </ul>
          </div>
        </div>
      </div>
...
<span id="route-users" data-route="{{ route('users') }}"></span>
<!-- /.content -->
@endsection
