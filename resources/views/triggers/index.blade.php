      ...
      <div class="col-md-12 add-button-margin" style="z-index: 1;">
        <div  style="float: left;">
          <a href="{{ route('trigger.create') }}">
            <button class="btn btn-primary">{{ __('app.create_trigger') }}</button>
          </a>
        </div>
        <div style="float: right;">
          <div class="btn-group">
            ...
            <ul class="dropdown-menu" role="menu">
              <li><a href="javascript:;" onclick="destroyMany('{{ route('trigger.destroy', ['id' => 0]) }}')"><i class="fa fa-trash"></i>{{ __('app.delete') }}</a></li>
            </ul>
          </div>
        </div>
      </div>
...
<span id="route-triggers" data-route="{{ route('triggers') }}"></span>
<!-- /.content -->
@endsection
